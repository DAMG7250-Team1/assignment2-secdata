...
class SECDataProcessor:
    def __init__(self):
        ...
        self.bucket_name = 'damg7245-assignment2-team-1'
        
        # S3 paths
        self.RAW_PREFIX = 'sec_data'
        self.EXTRACTED_PREFIX = 'raw/'
    ...
    #         zip_obj = s3_client.get_object(Bucket="damg7245-assignment2-team-1", Key=zip_key)
    #         print(f"Fetching S3 object with key: {zip_key}")

    #         # logger.info(f"Processing ZIP file: {zip_key}")
            
    #         aws_conn = BaseHook.get_connection("aws_default")

    #          # Initialize Boto3 session using Airflow credentials
    ...
    #         # Now use this client instead of self.s3_client
    #         zip_obj = s3_client.get_object(Bucket="damg7245-assignment2-team-1", Key=zip_key)
    ...
    def extract_zip_file(self, year, quarter):
        ...
        try:
            ...
            print(f"Error in extract_zip_file: {str(e)}")
            raise
